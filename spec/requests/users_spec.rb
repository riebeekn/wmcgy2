  ...
  describe "edit account" do
    context "oauth authentication account" do
      ...
      describe "items that should be present on page" do
        ...
        it { should_not have_selector('header', text: 'Change email') }
        it { should_not have_field('Email', with: user.email) }
        it { should_not have_button('Update email') }
        #change password section
        it { should_not have_selector('header', text: 'Change password') }
        it { should_not have_field('Old password') }
        it { should_not have_field('New password') }
        it { should_not have_field('Confirm new password') }
        it { should_not have_button('Update password') }
    ...
    context "custom authentication account" do
